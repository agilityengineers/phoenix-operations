...
// Privacy Policy + Terms of Service drafts — tabbed per the design.
// Both are flagged for attorney review before launch.
...
export async function generateMetadata({
  ...
  if (!entry) return {};
  return { title: entry.title, alternates: { canonical: `/legal/${doc}` } };
}
